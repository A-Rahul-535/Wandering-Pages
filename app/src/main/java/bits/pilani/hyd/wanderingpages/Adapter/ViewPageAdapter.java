package bits.pilani.hyd.wanderingpages.Adapter;
...
import bits.pilani.hyd.wanderingpages.MainActivity;
import bits.pilani.hyd.wanderingpages.Model.BookPost;
import bits.pilani.hyd.wanderingpages.Model.User;
import bits.pilani.hyd.wanderingpages.Pager.VerticalViewPager;
import bits.pilani.hyd.wanderingpages.R;

import bits.pilani.hyd.wanderingpages.MessageActivity;
...
public class ViewPageAdapter extends PagerAdapter {
 ...
 //------------------------------------current user latitude and longitude are getting values-------------------------/
        ...
        bookTags.setText ( mBookPosts.get ( position ).getBook_author() );
